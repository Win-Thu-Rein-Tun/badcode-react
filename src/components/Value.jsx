...
const Value = () => (
  <div className="mb-[4rem] mt-[6rem]">
    <h1 className="text-textColor text-[25px] py-[2rem] pb-[3rem] font-bold block">
      The value that hold true and to account
    </h1>
      ...
      <div className="rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]">
        <div className="flex items-center gap-3">
          <div className="p-[4px] rounded-[.8rem] bg-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
            <img src={people04} alt="" className="w-[70%]" />
          </div>
    ...
    <div className="mt-[2rem] flex justify-between bg-greyIsh p-[5rem] rounded-[10px]">
      <div>
      ...
      <button
        className="border-[2px] rounded-[10px] py-[4px] px-[50px] text-[18px]font-semibold text-blueColor hover:bg-white border-blueColor"
      >
        Get Started
      </button>
    </div>
