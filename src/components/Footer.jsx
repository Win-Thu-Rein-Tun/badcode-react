  ...
  <div className="footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center">
    ...
    <div className="grid ml-[100px]">
      ...
      <div className="grid gap-3">
        ...
        <li className="text-white oapcity-[.7] hover:gpacity-[1]">News</li>
        <li className="text-white oapcity-[.7] hover:opacity-[1]">FAQ</li>
      </div>
    </div>
    <div className="grid ml-[50px]">
      <span className="divTitle text-[18px] font-semibold pb-[1.5rem] text-white">
        Resources
      </span>
      <div className="grid gap-3">
        <li className="text-white oapcity-[.7] hover:opacity-[1]">Account</li>
        <li className="text-white oapcity-[.7] hover: opacity-[1]">
          Support Center
        </li>
        <li className="text-white oapcity-[.7] hover:gpacity-[1]">Feedback</li>
        <li className="text-white oapcity-[.7] hover:opacity-[1]">
          Contact Us
        </li>
      </div>
    ...
    <div className="grid">
      ...
      <div className="grid gap-3">
        ...
        <li className="text-white oapcity-[.7] hover:gpacity-[1]">Request</li>
        <li className="text-white oapcity-[.7] hover:opacity-[1]">Carrers</li>
      </div>
    </div>
    <div className="grid">
      <span className="divTitle text-[18px] font-semibold pb-[1.5rem] text-white">
      ...
      <div>
        <small className="text-[14px] text-white">fackebook@email.com</small>
        ...
        <div className="icons flex gap-4 py-[1rem]">
          ...
          <BsFacebook
            className="bg-white p-[8px] h-[35px] w-[35px] rounded-full icon Itext-blueColor"/>
